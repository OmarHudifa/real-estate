...
exports.propertyTypeEnum = (0, pg_core_1.pgEnum)('PropertyType', [
    'Rooms',
    'Tinyhouse',
    'Apartment',
    'Villa',
...
exports.applicationStatusEnum = (0, pg_core_1.pgEnum)('ApplicationStatus', [
    'Pending',
    'Denied',
    'Approved'
]);
exports.paymentStatusEnum = (0, pg_core_1.pgEnum)('PaymentStatus', [
    'Pending',
    'Paid',
    'PartiallyPaid',
    'Overdue'
