        ...
        return(
            <View className='mt-4 mb-7'>
                <Heading level={3} className='!text-2xl !font-bold'>
                   ...
                   <p className='text-muted-foreground mt-2'><span className='font-bold'>Welcome!</span> Please sign in to continue</p>
            </View>
        )
    },
    SignIn:{
         ...
         Footer(){
           ...
           return(
             <View className='text-center mt-4'>
                   ...
                   <button onClick={toSignIn} className='text-primary hover:underline bg-transparent border-none p-0'>Sign in</button>
                   </p>
            </View>
           )
        }
