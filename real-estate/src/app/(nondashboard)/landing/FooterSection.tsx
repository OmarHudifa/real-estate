...
const FooterSection = () => {
  return (
    <footer className='border-t border-grey-200 py-20'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='flex space-x-4 mb-4'>
            <a href="#" aria-label='Facebook' className='hover:text-primary-600'>
              <FontAwesomeIcon icon={faFacebook} className="h-6"></FontAwesomeIcon>
            </a>
             <a href="#" aria-label='Instagram' className='hover:text-primary-600'>
              <FontAwesomeIcon icon={faInstagram} className="h-6"></FontAwesomeIcon>
            </a>
             <a href="#" aria-label='Twitter' className='hover:text-primary-600'>
              <FontAwesomeIcon icon={faTwitter} className="h-6"></FontAwesomeIcon>
            </a>
             <a href="#" aria-label='Linkedin' className='hover:text-primary-600'>
              <FontAwesomeIcon icon={faLinkedin} className="h-6"></FontAwesomeIcon>
            </a>
             <a href="#" aria-label='youtube' className='hover:text-primary-600'>
              <FontAwesomeIcon icon={faYoutube} className="h-6"></FontAwesomeIcon>
            </a>
          </div>
        </div>
