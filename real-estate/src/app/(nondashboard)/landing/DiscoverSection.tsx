...
const DiscoverSection = () => {
  return (
   <motion.div initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.8 }} variants={containerVariants} className='py-12 bg-white mb-16'>
      <div className='max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16'>
        <motion.div variants={itemVariants} className='my-12 text-center'>
          ...
          <p className='mt-2 text-gray-500 max-w-3xl mx-auto'>Searching for your dream rental property has never been easier. With
