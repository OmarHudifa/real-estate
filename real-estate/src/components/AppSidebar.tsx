...
import { Building, FileText, Heart, Home, Settings, X,Menu} from 'lucide-react'
...
const AppSidebar = ({userType}:AppSidebarProps) => {
  ...
  return <Sidebar collapsible='icon' className='fixed bg-white left-0 shadow-lg' 
  style={{top:`${NAVBAR_HEIGHT}px`,height:`calc(100vh -${NAVBAR_HEIGHT})`}}>
    <SidebarHeader>
        <SidebarMenu>
            <SidebarMenuItem>
            ...
            const isActive=pathname===link.href
                 return(
                    <SidebarMenuItem key={link.href}>
                        <SidebarMenuButton asChild className={cn("flex items-center px-7 py-7",isActive?"":"")}>
